...
public class ConfigUtils {
	...
	public ConfigUtils() throws IOException {
		...
		logger.info("Log4j path : " + System.getProperty("user.dir") + "\\log4j.properties");
		String logPath = System.getProperty("user.dir") + File.separator + "target" + File.separator + "logger.log";
